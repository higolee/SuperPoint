...
if __name__ == '__main__':
    ...
    parser.add_argument('--W', type=int, default=176,
                        help='The width in pixels to resize the images to. \
                                (default: 640)')
    parser.add_argument('--k_best', type=int, default=300,
    ...
    with tf.Session(graph=graph) as sess:
        ...
        cv2.imwrite(str(Path(EXPER_PATH, "SuperPoint_matches.jpg")), matched_img)
        ...
        sift_matched_img = cv2.drawMatches(img1_orig, sift_kp1, img2_orig,
                                           ...
                                           matchColor=(0, 255, 0),
                                           singlePointColor=(0, 0, 255))
        cv2.imwrite(str(Path(EXPER_PATH, "SIFT_matches.jpg")), sift_matched_img)
